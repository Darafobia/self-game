...
var empty,s1,s2,score;

var fr;
var starImg,star,star1;
...
function preload()
{
  ...
  s1= loadAnimation("one_star.png");
  s2= loadAnimation("stars.png");
...
function setup() 
{
  ...
  button.mouseClicked(drop);
   ...
   score.scale = 0.2
   score.addAnimation("noPoints",empty);
   score.addAnimation("1Points",s1);
   score.addAnimation("2Points",s2);
   score.changeAnimation("noPoints");
...
function draw() 
{
  ...
  if(fruit!=null && fruit.position.y>=650)
  {
   ...
   if(star.visible===false && star1.visible===false){
    textSize(48)
    text("Well Done!!!",130,250)
